...
public class MarksysVC_ADA implements MarksysVC {
    Utilities utilities = new Utilities();

    DateTimeFormatter dtf = DateTimeFormatter.ofPattern("yyyy-MM-dd_HH-mm-ss");
    LocalDateTime now = LocalDateTime.now();

    ArrayList<Locations> ADAlocations = utilities.getADALocations();
    HashMap<String, String> parameters = utilities.getParameters();
    HashMap<String, String> svParams = utilities.getServerParameters();

    boolean status = false;

    String ADAFilePath = System.getProperty("user.dir")+"\\JarFilesADA";
    ...
    String copiedScriptPath = System.getProperty("user.dir")+"\\ScriptFilesADA\\";
    ...
    public void copyMarksysJarFiles() {
        ...
        if (ADAlocations.isEmpty()) {
            ...
            for (Locations location : ADAlocations) {
                try {
                    ...
                    if (session.isConnected()) {
                        ...
                        if (channelSftp.isConnected()) {
                            ...
                            try {
                                ...
                                targetJarFile = new File(ADAFilePath + "\\" + marksysFileName);
                                ...
                                try {
                                    ...
                                    channelSftp.put(ADAFilePath + "\\" + marksysFileName, serverMarksysPath + marksysFileName);
                    ...
                    if (session.isConnected()) {
                        ...
                        if (channelSftp.isConnected()) {
                            ...
                            try {
                                ...
                                targetJarFile = new File(ADAFilePath + "\\" + posFileName);
                                ...
                                try {
                                    ...
                                    channelSftp.put(ADAFilePath + "\\" + posFileName, serverPosPath + posFileName);
    ...
    public void runScriptFile() {
        ...
        System.out.println("\nScript Running....\n");
        ArrayList<Locations> locations = utilities.msqlADAConnection();
