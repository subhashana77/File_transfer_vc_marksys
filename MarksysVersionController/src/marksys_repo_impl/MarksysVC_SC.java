...
public class MarksysVC_SC implements MarksysVC {
    Utilities utilities = new Utilities();

    DateTimeFormatter dtf = DateTimeFormatter.ofPattern("yyyy-MM-dd_HH-mm-ss");
    LocalDateTime now = LocalDateTime.now();

    ArrayList<Locations> SClocations = utilities.getSCLocations();
    HashMap<String, String> parameters = utilities.getParameters();
    HashMap<String, String> svParams = utilities.getServerParameters();

    boolean status = false;

    String SCFilePath = System.getProperty("user.dir")+"\\JarFilesSC";
    ...
    String copiedScriptPath = System.getProperty("user.dir")+"\\ScriptFilesSC\\";
    ...
    public void copyMarksysJarFiles() {
        ...
        if (SClocations.isEmpty()) {
            ...
            for (Locations location : SClocations) {
                try {
                    ...
                    if (session.isConnected()) {
                        ...
                        if (channelSftp.isConnected()) {
                            ...
                            try {
                                ...
                                targetJarFile = new File(SCFilePath + "\\" + marksysFileName);
                                ...
                                try {
                                    ...
                                    channelSftp.put(SCFilePath + "\\" + marksysFileName, serverMarksysPath + marksysFileName);
                    ...
                    if (session.isConnected()) {
                        ...
                        if (channelSftp.isConnected()) {
                            ...
                            try {
                                ...
                                targetJarFile = new File(SCFilePath + "\\" + posFileName);
                                ...
                                try {
                                    ...
                                    channelSftp.put(SCFilePath + "\\" + posFileName, serverPosPath + posFileName);
    ...
    public void runScriptFile() {
        ...
        System.out.println("\nScript Running....\n");
        ArrayList<Locations> locations = utilities.msqlSCConnection();
